<?php
	...
	$pages = array(
		...
		'1'	=> array('id' => '4', 'alias' => 'Oynadığımız-Server', 'file' => '4.php','controllers' => array()),
		'2'	=> array('id' => '2', 'alias' => 'Yönetim', 'file' => '2.php','controllers' => array()),
		'3'	=> array('id' => '3', 'alias' => 'İletişim', 'file' => '3.php','controllers' => array())
	);
	$forms = array(
		'3'	=> array(
			'f3923667' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => unserialize('s:14:"Form was sent.";'), 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'maxFileSizeTotal' => '2', 'fields' => array( array( 'fidx' => '0', 'name' => 'İsminiz', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '1', 'name' => 'İletişim Bilgileriniz', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '2', 'name' => 'Mesajınız', 'type' => 'textarea', 'required' => 1, 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	$base_lang = 'en';
	$site_id = "fd2e8043";
	$websiteUID = "16842790b3a69f64018131538510005bf6418e5113009156ebefd30286acdbeec93fce824720fce9";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'www.nmtd.ga';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "http://us.zyro.com/comment_callback/";
	$user_key = "jDcNNYe5HiK2dmQ2DOI5cD7EWx01X42N6LE=";
	$user_hash = "be233a36a3d8ebec";
